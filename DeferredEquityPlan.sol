...
contract DeferredEquityPlan {
    //uint fakenow = now; to test replace all now with fakenow
   ...
   // function fast forward by 100 days
   //function fastforward()public {fakenow += 100 days;}
    ...
    uint public distributed_shares; // starts at 0, this is the default
    ...
    function distribute() public {
        ...
        // Your code here!
        require(unlock_time <= now ,"its not time");
        require(distributed_shares <= total_shares, "you have no shares left");
